...
public class VirtualPetShelterTest {
	...
	VirtualPetShelter underTest = new VirtualPetShelter(50, 0, 0, 0);
	...
	public void shouldHaveADefaultHungerOf100() {
		VirtualPetShelter underTest = new VirtualPetShelter(100, 0, 0, 0);
		int check = underTest.getHunger();
	...
	public void shouldHaveADefaultThirstOf10() {
		VirtualPetShelter underTest = new VirtualPetShelter(0, 10, 0,0);
	...
	public void shouldHaveDefaultPlayOf100() {
		VirtualPetShelter underTest = new VirtualPetShelter(0,0,100,0);
	...
	public void shouldHaveDefaultHappinessOf50() {
		VirtualPetShelter underTest = new VirtualPetShelter(0,0,0,50);
	...
	public void shouldHaveHappinessOf100AfterDrink() {
		VirtualPetShelter underTest = new VirtualPetShelter(0,0,0,100);
		int check = underTest.getHappiness();
		assertEquals(100, check);
	...
	public void shouldHaveHappinessOf150AfterSwim() {
		VirtualPetShelter underTest = new VirtualPetShelter(0,0,0,150);
		int check = underTest.getHappiness();
		assertEquals(150, check);
}
}